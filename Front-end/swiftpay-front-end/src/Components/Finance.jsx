    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                console.error('Error fetching finance news data:', error);
            }
        };
                        ...
                        <div key={index} className="w-full p-4 mb-4">
                            <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col md:flex-row items-center">
                                ...
                                <div className="p-4 w-full md:w-1/2">
                                    ...
                                    <div className="flex justify-end">
                                        ...
                                        <button
                                            className="bg-red-500 text-white px-4 py-2 ml-2 rounded-md hover:bg-red-600 focus:outline-none"
                                            onClick={() => handleDislike(index)}
                                        >
                                            <FontAwesomeIcon icon={faThumbsDown} className="mr-2" />
                                        </button>
                                        <button
                                            className="bg-green-500 text-white px-4 py-2 ml-2 rounded-md hover:bg-green-600 focus:outline-none"
                            ...
                            <div className="mt-4">
                                {commentsVisible[index] && comments[index] && (
                                    <div className="mt-4">
                                        <p className="text-sm text-gray-600">{Object.keys(comments[index]).length} Comments</p>
                                        {Object.entries(comments[index])
                                            .sort((a, b) => new Date(a[1].timestamp) - new Date(b[1].timestamp))  // Sort comments by timestamp
                                                    ...
                                                    {editCommentId?.index === index && editCommentId?.commentId === commentId ? (
                                                        ...
                                                        <div className="flex items-start justify-between">
                                                            <div className="flex-1">
                                                                ...
                                                                <p className="text-sm text-gray-500 mt-1">{commentData.formattedTimestamp}</p>
                                                            </div>
