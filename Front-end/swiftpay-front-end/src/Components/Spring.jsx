...
const IMAGES = [
  'https://th.bing.com/th/id/OIP.fB_O-fe1a1ipKKw-e-MUSgAAAA?rs=1&pid=ImgDetMain',
  'https://mediaim.expedia.com/destination/1/eb5421d0fda773cc8e31e038bbd68e90.jpg?impolicy=fcrop&w=1040&h=580&q=mediumHigh',
  'https://wallpapercave.com/wp/wp7784571.jpg',
];
      ...
      <div className={styles.container__inner}>
        {transitions((springs, item) => (
          <animated.div className={styles.img__container} style={springs}>
            <img src={IMAGES[item]} alt={`Image ${item}`} />
          </animated.div>
        ))}
        <div className={styles.ticker}>
          <div />
          <animated.svg width="40" height="40" viewBox="0 0 40 40" style={springs}>
